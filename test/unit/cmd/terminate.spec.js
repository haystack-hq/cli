...
describe('cmd-terminate', function () {
    ...
    it('should get response with no length, and err appropriately', function () {
        var apiAdapter = new ApiTestAdapter({
            uri: 'stacks',
            response: []
        })
        ...
        expect(cmdTerminate.terminateStack({ identifier: 'abc' }))
    ...
    it('should print feedback messages', function (done) {
    ...
    it('should close the connection with just the terminating message when status is not terminating or terminated', function (done) {
        const wss = new WebSocket.Server({ port: 3111 });
